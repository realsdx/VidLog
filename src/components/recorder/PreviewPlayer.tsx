  ...
  return (
    <div class="flex flex-col gap-4 w-full">
      ...
      <div class="flex flex-col gap-1.5">
        <label class="text-xs text-text-secondary font-mono uppercase tracking-wider">
          Title
        </label>
        <input
          type="text"
          ...
          class="bg-bg-elevated border border-border-default rounded-md px-3 py-2 text-sm text-text-primary placeholder:text-text-secondary/50 focus:outline-none focus:border-accent-cyan/60 transition-colors"
        />
      </div>
